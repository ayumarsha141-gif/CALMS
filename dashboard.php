...
if (empty($skills)) {
    $skills = [
        ['skill_name' => 'Python',          'category' => 'Programming', 'industry_level' => 8, 'student_level' => 6, 'gap' => 2],
        ['skill_name' => 'JavaScript',      'category' => 'Programming', 'industry_level' => 9, 'student_level' => 5, 'gap' => 4],
        ['skill_name' => 'SQL',             'category' => 'Database',    'industry_level' => 7, 'student_level' => 6, 'gap' => 1],
        ['skill_name' => 'Machine Learning','category' => 'AI/ML',       'industry_level' => 8, 'student_level' => 2, 'gap' => 6],
        ['skill_name' => 'Git',             'category' => 'Tools',       'industry_level' => 9, 'student_level' => 7, 'gap' => 2],
    ];
}
...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="skill_gap.php">
            <svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>
            Skill Gap
        </a>
        <a href="career_roadmap.php">
        ...
        <a href="certifications.php">
            <svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><circle cx="12" cy="8" r="6"/><path d="M9 12l2 2 4-4m-8 8h10"/></svg>
            Sertifikasi
        </a>
        <a href="lab_recommendation.php">
